...
public class HappyBirthday extends AppCompatActivity {
    ...
    final String[] notesList = {"D4", "E4", "F#4", "G4", "D5", "B4", "C5", "A4"};
    //// TODO: 12/1/16 consider making it a hashmap???
    ArrayList<Float> birthdaySong;
    ...
    public void createBirthdaySong(){
        birthdaySong.add(noteD);
        birthdaySong.add(noteD);
        birthdaySong.add(noteE);
        birthdaySong.add(noteD);
        birthdaySong.add(noteG);
        birthdaySong.add(noteF);
        birthdaySong.add(noteD);
        birthdaySong.add(noteD);
        birthdaySong.add(noteE);
        birthdaySong.add(noteD);
        birthdaySong.add(noteA);
        birthdaySong.add(noteG);
        birthdaySong.add(noteD);
        birthdaySong.add(noteD);
        birthdaySong.add(noteD5);
        birthdaySong.add(noteB);
        birthdaySong.add(noteG);
        birthdaySong.add(noteF);
        birthdaySong.add(noteE);
        birthdaySong.add(noteC5);
        birthdaySong.add(noteC5);
        birthdaySong.add(noteB);
        birthdaySong.add(noteG);
        birthdaySong.add(noteA);
